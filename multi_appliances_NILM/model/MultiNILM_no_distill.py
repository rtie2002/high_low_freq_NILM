"""MultiNILM snapshot WITHOUT cross-appliance PAD-lite distill.

Frozen from git commit 6df298f54ea0f0a06bc14e15d664150e65a97872
(multi_appliances_NILM/model/MultiNILM.py at that revision).

Keep for B0 / ablation. Distilled model: model/MultiNILM.py

Train:
  python main.py --mode train_evaluate --model multinilm_no_distill \
    --experiment config/experiment_ukdale.yaml \
    --model-config config/models/multinilm_no_distill.yaml
"""
