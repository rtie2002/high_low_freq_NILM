"""Adapter: MultiNILM + fractional channels + KLE 2D spectrogram (FiLM)."""
...
from model.MultiNILM_schirmer import build_multinilm_schirmer


class MultiNILMSchirmerAdapter(MultiNILMAdapter):
    name = "multinilm_schirmer"
    ...
    def build_model(self, device: torch.device) -> torch.nn.Module:
        ...
        model = build_multinilm_schirmer(
            arch,
