...
```powershell
python main.py --model sgn --mode train_inference --data_source csv --csv_config baseline/SGN/configs/training_data_ukdale_cross_house.json --model_config baseline/SGN/configs/sgn_ukdale_cross_house.json
```
